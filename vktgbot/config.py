...
REQ_FILTER: str = os.getenv("VAR_REQ_FILTER", "")
REQ_RETURN_BANNED: int = int(os.getenv("VAR_REQ_RETURN_BANNED", 0))
REQ_SOURCE_IDS: str = os.getenv("VAR_REQ_SOURCE_IDS", "")

SINGLE_START: bool = os.getenv("VAR_SINGLE_START", "").lower() in ("true",)
TIME_TO_SLEEP: int = int(os.getenv("VAR_TIME_TO_SLEEP", 120))
SHOW_ORIGINAL_POST_LINK: bool = os.getenv("VAR_SHOW_ORIGINAL_POST_LINK", "").lower() in ("true",)
SHOW_COPYRIGHT_POST_LINK: bool = os.getenv("VAR_SHOW_COPYRIGHT_POST_LINK", "").lower() in ("true",)
